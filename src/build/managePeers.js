...
},{"./ec":39,"js-sha3":33,"node-fetch":36}],38:[function(require,module,exports){
...
inputButton.onclick = () => {
    ...
    let data = new Peer(newPeerAddress)
    fetch("addPeer", {
        method: "POST",
        headers: {
            'Content-Type' : "application/json"
...
},{"elliptic":3,"js-sha3":33}],40:[function(require,module,exports){
