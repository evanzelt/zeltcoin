...
class Blockchain { 
    ...
    receiveChain(newChain) {
        if(newChain.isValid() && newChain.length > this.chain.length) { 
            this.chain = newChain
        }
    }

    parseChain(chainString) { 
        let chain = JSON.parse(chainString)
        let parsedChain = []
...
},{"./ec":38,"js-sha3":33}],37:[function(require,module,exports){
...
},{"../blockchain":36,"../ec":38}],38:[function(require,module,exports){
...
},{"elliptic":3,"js-sha3":33}],39:[function(require,module,exports){
